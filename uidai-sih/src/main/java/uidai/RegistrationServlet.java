	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!"0".equals(AbleToAddOrNot)) {
			...
			out.println( "<html>\r\n"
					...
					+ " 			</td> \r\n"
					+ " 			<td>\r\n"
					+ " 				<img src = \"https://upload.wikimedia.org/wikipedia/en/thumb/c/cf/Aadhaar_Logo.svg/1200px-Aadhaar_Logo.svg.png\"style = \"float: right; width:168px; height:90px; margin-left:40px\">\r\n"
					+ " 			</td>\r\n"
					+ " 		</tr>\r\n"
					+ " 	</table> "
					+ "	<div class = \"admin\">\r\n"
